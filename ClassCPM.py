...
from interfaz.ui_fecha import Ui_modalFecha
...
class ClassCPM(QMainWindow):

    def __init__(self, ui):
        super(ClassCPM, self).__init__()
        self.ui = ui
    ...
    def generarTablaPer(self):
        ...
        self.listColumnas = [" Actividad ", " Detalle ", " Predecesores ", " To ", " Tn ", " Tp ", " D i,j ", " O i,j ", " Ti0 ", " Ti1 ", " Tj0 "," Tj1 ", " MT i,j ", " MI i,j ", " Fecha Inicio temprano ", " Fecha Inicio tardío ", " Fecha Fin temprano ", " Fecha Fin tardío "]
        # insertar columnas
        for i in range(18):
            item = QTableWidgetItem(self.listColumnas[i])
            item.setBackground(QtGui.QColor(37, 40,80))
            item.setForeground(QBrush(QColor(255, 225, 255)))
        ...
        self.show_popup_InformacionP(
            "Importante", "Los precedesores de las actividades deben ser ingresados separados por comas. \nPara las actividades sin predecesores debe ingresar N/A")
    ...
    def mostrarResultados(self):
        ...
        self.etiquetaFindes.setText(mensajeResultado+" para terminar el proyecto")
...
class DialogFecha(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("Seleccionar fecha de inicio del proyecto")
